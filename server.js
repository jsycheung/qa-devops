...
var rollbar = new Rollbar({
  accessToken: "59b809fa0b1b448eb34cca818455156a",
...
app.get("/api/robots", (req, res) => {
  try {
    ...
    rollbar.error("Cannot fetch all bots");
...
app.get("/api/robots/five", (req, res) => {
  try {
    ...
    rollbar.info("Five bots drawn successfully");
...
app.get("/api/player", (req, res) => {
  try {
    rollbar.info("Player record fetched");
